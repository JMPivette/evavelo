...
Pour qu'un fichier xlsx puisse être ouvert avec `read_evavelo()`, il doit comporter au moins les 6 onglets suivants:
...
La variable `categorie_visuelle_cycliste` de **comptages_man_post_traitements** et aussi vérifiées et ne doit contenir que les valeurs suivantes: `Loisir`, `Sportif`, `Utilitaire` et `Itinérant`.
