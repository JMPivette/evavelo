...
L'algorithmie est identique sur ces 3 cas qui correspondent à une categorie questionnaire "Itinérant" là ou la categorie visuelle indique autre chose
  ...
  mutate(
    categorie_corrige = 
      case_when(
        iti_any ~ "Itinérant",
        type_sortie == "Plusieurs jours" & dms > 1 ~ "Itinérant",
        TRUE ~ categorie_visuelle_cycliste
      ))  
