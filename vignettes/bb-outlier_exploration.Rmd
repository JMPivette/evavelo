...
### depense groupées par categorie
Pour les detections d'anomalies sur les dépenses, le groupement catégorie sauf pour les cas spécifiques TO, transport et heberement.
Attention, ces données sont vides dans mon fichier template.
...
### depense groupées par  mode d'hergement 

Ces dépenses sont groupées par mode d'hebergement:  **tour_dep_to_jour (3.1.26.2)** et **tour_dep_heb (3.1.26.3)**
...
### depenses transport [tour_dep_transp] (3.1.26.4)
Le chapitre 3.1.26.4 inque plutôt des corrections et non des contrôles sur **[tour_dep_transp]**
Par certain de ce qu'il faut vérifier.
